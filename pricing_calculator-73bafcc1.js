...
var AddItemButton = React.createClass({displayName: "AddItemButton",
  ...
  render: function() {
    ...
    return(
        React.createElement("li", {className: "mb1"}, 
        React.createElement("button", {onClick: this.handleClick, className: "btn btn-xs"}, displayName)
        )
        );
  }
});
...
var CalculationBox = React.createClass({displayName: "CalculationBox",
  ...
  render: function() {
    ...
    if (grandTotal > 0) {
      var panelFooter = React.createElement("div", {className: "panel-footer"}, 
        React.createElement("div", null, 
        React.createElement("em", {className: "mr2"}, "You should charge: "), 
        React.createElement("strong", {className: "pull-right"}, "₹", grandTotal)
        ), 
        React.createElement("button", {onClick: this.handleClickReset, className: "mr2 btn btn-link btn-xs"}, "reset")
        )
    } else {
      var panelFooter = React.createElement("div", {className: "panel-footer"}, React.createElement("em", null, "Pick out an ingredient to get started!"))
    }

    return (
        React.createElement("div", {className: "panel"}, 
        React.createElement("ul", {className: "list-group"}, 
        React.createElement(CalculationItem, {itemName: "Ingredients", itemTotal: ingredientsTotal}), 
        React.createElement(CalculationItem, {itemName: "Supplies", itemTotal: suppliesTotal}), 
        React.createElement(CalculationItem, {itemName: "Time", itemTotal: timeTotal}), 
        React.createElement(CalculationItem, {itemName: "Overhead", itemTotal: overheadTotal}), 
        React.createElement(CalculationItem, {itemName: "Delivery", itemTotal: deliveryTotal})
        ), 
        panelFooter
        )
        );
  ...
  render: function() {
    if (typeof this.props.itemTotal != 'undefined' && this.props.itemTotal > 0) {
      return (
          ...
          React.createElement("span", {className: "total-label"}, this.props.itemName, " total:"), 
          React.createElement("strong", {className: "pull-right"}, "₹", this.props.itemTotal)
          )
          );
    } else {
      return null;
...
var Calculator = React.createClass({displayName: "Calculator",
  ...
  render: function() {
    var sidebar = React.createElement("div", {className: "mb4"}, React.createElement(CalculationBox, {ingredients: this.state.ingredients, supplies: this.state.supplies, hours: this.state.hours, wage: this.state.wage, overhead: this.state.overhead, miles: this.state.miles, rate: this.state.rate, onReset: this.resetAllInput}), 
      React.createElement("div", {className: "fb-share-button", "data-href": "https://www.facebook.com/bakecalc", "data-layout": "button_count"})
      )
    ...
    return (
        ...
        React.createElement(ItemsBox, {name: "Ingredients", activeItems: this.state.ingredients, presetItems: PRESET_INGREDIENTS, onUserInput: this.handleIngredientsInput, iconClass: "fa-birthday-cake"}), 
        React.createElement(ItemsBox, {name: "Supplies", activeItems: this.state.supplies, presetItems: PRESET_SUPPLIES, onUserInput: this.handleSuppliesInput, iconClass: "fa-cutlery"}), 
        React.createElement(TimeBox, {onUserInput: this.handleTimeInput, hours: this.state.hours, wage: this.state.wage}), 
        React.createElement(OverheadBox, {onUserInput: this.handleOverheadInput, overhead: this.state.overhead}), 
        React.createElement(DeliveryBox, {onUserInput: this.handleDeliveryInput, miles: this.state.miles, rate: this.state.rate})
        )
        ), 
        React.createElement("div", {className: "col-md-4"}, 
        React.createElement("div", {className: "affix hidden-xs hidden-sm"}, 
        sidebar
        ), 
        React.createElement("div", {className: "visible-sm visible-xs"}, 
        sidebar
        )
        )
        )
...
var DeliveryBox = React.createClass({displayName: "DeliveryBox",
  handleChange: function(event) {
    ...
    render: function() {
      var inputFieldsClasses = classNames({
        'form-group': true,
        'input-row': true,
        'has-error': Util.isNonemptyInvalidNumber(this.props.miles) || Util.isNonemptyInvalidNumber(this.props.rate)
      });

      return (
        React.createElement("div", {className: "panel"}, 
        React.createElement("div", {className: "panel-heading"}, 
        React.createElement("h2", {className: "panel-title"}, 
        React.createElement("span", {className: "fa-stack"}, 
        React.createElement("i", {className: "fa fa-circle fa-stack-2x"}), 
        React.createElement("i", {className: "fa fa-truck fa-stack-1x fa-inverse"})
        ), 
        "Delivery"
        )
        ), 
        React.createElement("div", {className: "panel-body"}, 
        React.createElement("div", {className: inputFieldsClasses}, 
        React.createElement("div", {className: "col-sm-3"}, 
        React.createElement("input", {type: "number", className: "form-control input-sm", ref: "deliveryMilesInput", onChange: this.handleChange})
        ), 
        React.createElement("label", {className: "col-sm-2 control-label"}, 
        React.createElement("strong", null, "Km"), " at" 
        ), 
        React.createElement("div", {className: "col-sm-5"}, 
        React.createElement("div", {className: "input-group input-group-sm"}, 
        React.createElement("span", {className: "input-group-addon"}, "₹"), 
        React.createElement("input", {type: "number", defaultValue: "12.00", className: "form-control input-sm", ref: "deliveryRateInput", onChange: this.handleChange}), 
        React.createElement("span", {className: "input-group-addon"}, "/", React.createElement("sub", null, "Km"))
        )
        )
        ), 
        //React.createElement("p", null, "The current ", React.createElement("a", {href: "http://www.gsa.gov/portal/content/100715", target: "_blank"}, "federal reimbursement rate"), " for mileage is ₹12.00 per Km, which is a good place to start. Don't forget to charge for the entire round-trip!")
        )
        )
        );
    }
...
var ItemRow = React.createClass({displayName: "ItemRow",
  handleChange: function(event) {
    var changes = {
      quantity: this.refs.quantityInput.getDOMNode().value,
      cost: this.refs.costInput.getDOMNode().value
    };
    this.props.onItemChange(this.props.item.key, changes);
  },

  handleRemoveClick: function(event) {
    this.props.onItemRemove(this.props.item.key);
  },
  ...
  render: function() {
    var rowClasses = classNames({
      'form-group': true,
      'input-row': true,
      'has-error': Util.isInvalidNumber(this.props.item.quantity) || Util.isInvalidNumber(this.props.item.cost)
    });

    if ( _.contains(_.pluck(this.props.presetItems, 'key'), this.props.item.key)) {

      var quantity = React.createElement("div", {className: "col-sm-2"}, 
        React.createElement("input", {defaultValue: this.props.item.quantity, className: "form-control input-sm", type: "number", ref: "quantityInput", onChange: this.handleChange})
        );

      if (this.props.item.unit) {

        var name = React.createElement("div", {className: "col-sm-4"}, 
          React.createElement("p", {className: "form-control-static text-overflow"}, 
            this.props.item.unit + 's', " of ", React.createElement("strong", null, this.props.item.name), " at"
          )
          );
        ...
        var name = React.createElement("div", {className: "col-sm-4"}, 
          React.createElement("p", {className: "form-control-static text-overflow"}, 
          React.createElement("strong", null, this.props.item.name), " at" 
          )
          );
      }

      var costAppend = React.createElement("span", {className: "input-group-addon"}, "/", React.createElement("sub", null, this.props.item.unit || 'each'));
    } else {

      var quantity = React.createElement("div", {className: "col-sm-5"}, 
        React.createElement("input", {hidden: true, value: this.props.item.quantity, ref: "quantityInput"}), 
        React.createElement("input", {defaultValue: this.props.item.name, type: "text", className: "form-control input-sm", placeholder: "6 spoons of nutella, etc."})
        );

      var name = React.createElement("label", {className: "col-sm-1 control-label"}, "at");
    ...
    return (
        ...
        React.createElement("div", {className: "input-group input-group-sm"}, 
        React.createElement("span", {className: "input-group-addon"}, "₹"), 
        React.createElement("input", {defaultValue: this.props.item.cost, type: "number", className: "form-control", ref: "costInput", onChange: this.handleChange}), 
        costAppend
        )
        ), 
        React.createElement("div", {className: "col-sm-2"}, 
        React.createElement("button", {className: "btn btn-link btn-xs", onClick: this.handleRemoveClick}, "remove")
        )
        )
        );
  }
...
var ItemsBox = React.createClass({displayName: "ItemsBox",
  handleItemSelect: function(item) {
    ...
    item["quantity"] = 1;
    if(!item.key) { item.key = _.uniqueId(); }
    items.push(item);
  ...
  handleItemChange: function(key, changes) {
    ...
    var newItems = _.map(items, function(item) {
      return (item.key === key ? _.assign(item, changes) : item);
    });
    this.props.onUserInput(newItems);
  },

  handleItemRemove: function(key) {
    var items = this.props.activeItems;
    items = _.reject(items, function(i){ return i.key == key });
    this.props.onUserInput(items);
  },

  render: function() {
    var itemButtons = _.difference(this.props.presetItems, this.props.activeItems).map(function(presetItem) {
      return (
          React.createElement(AddItemButton, {onItemSelect: this.handleItemSelect, item: presetItem, key: presetItem.name})
          );
    }.bind(this));

    var itemFields = this.props.activeItems.map(function(item) {
      return (
          React.createElement(ItemRow, {onItemChange: this.handleItemChange, onItemRemove: this.handleItemRemove, item: item, key: item.key, presetItems: this.props.presetItems})
          );
    }.bind(this));

    return (
        React.createElement("div", {className: "panel input-box"}, 
        React.createElement("div", {className: "panel-heading"}, 
        React.createElement("h2", {className: "panel-title"}, 
        React.createElement("span", {className: "fa-stack"}, 
        React.createElement("i", {className: "fa fa-circle fa-stack-2x"}), 
        React.createElement("i", {className: "fa fa-stack-1x fa-inverse " + this.props.iconClass})
        ), 
        this.props.name
        )
        ), 
        React.createElement("div", {className: "panel-body"}, 
        React.createElement("p", null, "Choose your items below"), 
        React.createElement("ul", {className: "list-inline item-buttons"}, 
        itemButtons, 
        React.createElement(AddItemButton, {onItemSelect: this.handleItemSelect, item: { quantity: 1, name: "", cost: null}})
        ), 
        itemFields
        )
        )
...
var OverheadBox = React.createClass({displayName: "OverheadBox",
  ...
  render: function() {
    var inputFieldsClasses = classNames({
      'form-group': true,
      'input-row': true,
      'has-error': Util.isNonemptyInvalidNumber(this.props.overhead)
    });
    return(
        React.createElement("div", {className: "panel input-box"}, 
        React.createElement("div", {className: "panel-heading"}, 
        ...
        React.createElement("span", {className: "fa-stack"}, 
        React.createElement("i", {className: "fa fa-circle fa-stack-2x"}), 
        React.createElement("i", {className: "fa fa-plug fa-stack-1x fa-inverse"})
        ), 
        "Overhead"
        )
        ), 
        ...
        React.createElement("div", {className: "input-group input-group-sm"}, 
        React.createElement("span", {className: "input-group-addon"}, "₹"), 
        React.createElement("input", {type: "number", className: "form-control input-sm", ref: "overheadInput", onChange: this.handleChange})
        )
        )
        ), 
        React.createElement("p", null, "When you bake, you use electricity, ovens, and other things. A fee for the use of equipment should be added to the cost.")
        )
        )
        );
    }
...
{ key: "baking-powder", name: "baking powder", unit: "tsp", cost: 0.0 },
{ key: "butter", name: "butter", unit: "stick", cost: 0.0 },
{ key: "chocolate-chips", name: "chocolate chips", unit: "cup", cost: 0.0 },
{ key: "cinnamon", name: "cinnamon", unit: "tsp", cost: 0.0 },
{ key: "cacao-powder", name: "cacao powder", unit: "tbsp", cost: 0.0 },
{ key: "eggs", name: "eggs", unit: null, cost: 0.0 },
{ key: "flour", name: "flour", unit: "cup", cost: 0.0 },
{ key: "milk", name: "milk", unit: "cup", cost: 0.0 },
{ key: "shortening", name: "shortening", unit: "cup", cost: 0.0 },
{ key: "sugar", name: "sugar", unit: "cup", cost: 0.0 },
{ key: "vanilla", name: "vanilla", unit: "tsp", cost: 0.0 },
{ key: "vegetable-oil", name: "vegetable oil", unit: "cup", cost: 0.0 },
{ key: "yeast", name: "yeast", unit: "tsp", cost: 0.0 }
];
var PRESET_SUPPLIES = [
{ key: "box", name: "boxes", cost: 0.0 },
{ key: "cake-circle", name: "cake circles", cost: 0.0 },
{ key: "dowel-rod", name: "dowel rods", cost: 0.0 }
];
/** @jsx React.DOM */
...
var TimeBox = React.createClass({displayName: "TimeBox",
  ...
  render: function() {
    var inputFieldsClasses = classNames({
      'form-group': true,
      'input-row': true,
      'has-error': Util.isNonemptyInvalidNumber(this.props.hours) || Util.isNonemptyInvalidNumber(this.props.wage)
    });
    ...
    return (
        ...
        React.createElement("span", {className: "fa-stack"}, 
        React.createElement("i", {className: "fa fa-circle fa-stack-2x"}), 
        React.createElement("i", {className: "fa fa-clock-o fa-stack-1x fa-inverse"})
        ), 
        "Time"
        )
        ), 
        React.createElement("div", {className: "panel-body"}, 
        React.createElement("p", null, "How much is your time worth?"), 
        React.createElement("div", {className: inputFieldsClasses}, 
        React.createElement("div", {className: "col-sm-3"}, 
        React.createElement("input", {type: "number", className: "form-control input-sm", ref: "timeHoursInput", onChange: this.handleChange})
        ), 
        React.createElement("label", {className: "col-sm-2 control-label"}, 
        React.createElement("strong", null, "hours"), " at" 
        ), 
        React.createElement("div", {className: "col-sm-5"}, 
        React.createElement("div", {className: "input-group input-group-sm"}, 
        React.createElement("span", {className: "input-group-addon"}, "₹"), 
        React.createElement("input", {type: "number", className: "form-control input-sm", ref: "timeWageInput", onChange: this.handleChange}), 
        React.createElement("span", {className: "input-group-addon"}, "/", React.createElement("sub", null, "hour"))
        )
        )
        ), 
        React.createElement("p", null, "You deserve to be paid a fair hourly rate for the time you spend baking. Don't forget sampling, planning or clean-up time!"
        )
        )
        )
        );
...
var Util = {
  isInvalidNumber: function(input) {
    return (isNaN(parseFloat(input)) || !isFinite(input) || input < 0);
  },

  isNonemptyInvalidNumber: function(input) {
    return (input && (isNaN(parseFloat(input)) || !isFinite(input) || input < 0));
  }
}
;
